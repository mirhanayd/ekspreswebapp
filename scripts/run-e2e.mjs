...
try {
  ...
  const { runServerlessAuthJourney, runServerlessTransportJourney, runServerlessSeatJourney } =
  ...
  if (rejectedLegacyRequests !== 0)
    throw new Error('Serverless auth/transport/seats attempted a legacy API request.');
